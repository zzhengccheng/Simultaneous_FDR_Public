...
pdf("Continuous_rho_s1=0s2=0.pdf")
FDR_and_power_plot(FDRmat=FDRmat, powermat=powermat, names=names, cols=cols, pchs=pchs, alpha=q, vary_list,xlab=xlab, title='',leg_coords=c(min(vary_list),0.5),show_legend=TRUE,labelsize=1.5,legsize=1.5,cexsize=1.8)
dev.off()
...
pdf("Continuous_rho_s1=40s2=40.pdf")
FDR_and_power_plot(FDRmat=FDRmat, powermat=powermat, names=names, cols=cols, pchs=pchs, alpha=q, vary_list,xlab=xlab, title='',leg_coords=c(min(vary_list),0.5),show_legend=TRUE,labelsize=1.5,legsize=1.5,cexsize=1.8)
dev.off()
...
pdf("Continuous_rho_s1=0s2=40.pdf")
FDR_and_power_plot(FDRmat=FDRmat, powermat=powermat, names=names, cols=cols, pchs=pchs, alpha=q, vary_list,xlab=xlab, title='',leg_coords=c(min(vary_list),0.5),show_legend=TRUE,labelsize=1.5,legsize=1.5,cexsize=1.8)
dev.off()
...
FDRmat=powermat=matrix(data=NA,nrow=length(vary_list),ncol=length(names))
for (i in 1:length(vary_list)){
	sigma1=sqrt(vary_list[i])
	sigma2=sqrt(5-sigma1^2)
	filename=paste("result_n1=",as.character(n1),"n2=",as.character(n2),"p=",as.character(p),"s0=",as.character(s0),"s1=",as.character(s1),"s2=",as.character(s2),"rho1=",as.character(rho1),"rho2=",as.character(rho2),"sigma1=",as.character(sigma1),"sigma2=",as.character(sigma2),"samesig=",as.character(samesig),"q=",as.character(q),"scale=",as.character(scale),"iniseed=",as.character(iniseed),".csv",sep="")
	tmp=c(read.csv(filename)[,2])
	FDRmat[i,]=tmp[c(1,3,5)]
	powermat[i,]=tmp[c(2,4,6)]
...
pdf("Continuous_sigma_s1=0s2=0.pdf")
FDR_and_power_plot(FDRmat=FDRmat, powermat=powermat, names=names, cols=cols, pchs=pchs, alpha=q, vary_list,xlab=xlab, title='',leg_coords=c(min(vary_list),0.5),show_legend=TRUE,labelsize=1.5,legsize=1.5,cexsize=1.8)
dev.off()
...
pdf("Continuous_sigma_s1=40s2=40.pdf")
FDR_and_power_plot(FDRmat=FDRmat, powermat=powermat, names=names, cols=cols, pchs=pchs, alpha=q, vary_list,xlab=xlab, title='',leg_coords=c(min(vary_list),0.5),show_legend=TRUE,labelsize=1.5,legsize=1.5,cexsize=1.8)
dev.off()
...
pdf("Continuous_sigma_s1=0s2=40.pdf")
FDR_and_power_plot(FDRmat=FDRmat, powermat=powermat, names=names, cols=cols, pchs=pchs, alpha=q, vary_list,xlab=xlab, title='',leg_coords=c(min(vary_list),0.5),show_legend=TRUE,labelsize=1.5,legsize=1.5,cexsize=1.8)
dev.off()
...
pdf("Continuous_s0samesig=0.pdf")
FDR_and_power_plot(FDRmat=FDRmat, powermat=powermat, names=names, cols=cols, pchs=pchs, alpha=q, vary_list,xlab=xlab, title='',leg_coords=c(min(vary_list),0.5),show_legend=TRUE,labelsize=1.5,legsize=1.5,cexsize=1.8)
dev.off()
...
pdf("Continuous_s1_s2samesig=0.pdf")
FDR_and_power_plot(FDRmat=FDRmat, powermat=powermat, names=names, cols=cols, pchs=pchs, alpha=q, vary_list,xlab=xlab, title='',leg_coords=c(min(vary_list),0.5),show_legend=TRUE,labelsize=1.5,legsize=1.5,cexsize=1.8)
dev.off()
...
pdf("Continuous_s2samesig=0.pdf")
FDR_and_power_plot(FDRmat=FDRmat, powermat=powermat, names=names, cols=cols, pchs=pchs, alpha=q, vary_list,xlab=xlab, title='',leg_coords=c(min(vary_list),0.5),show_legend=TRUE,labelsize=1.5,legsize=1.5,cexsize=1.8)
dev.off()
...
pdf("Continuous_rho_s1=0s2=0samesig=0.pdf")
FDR_and_power_plot(FDRmat=FDRmat, powermat=powermat, names=names, cols=cols, pchs=pchs, alpha=q, vary_list,xlab=xlab, title='',leg_coords=c(min(vary_list),0.5),show_legend=TRUE,labelsize=1.5,legsize=1.5,cexsize=1.8)
dev.off()
...
pdf("Continuous_rho_s1=40s2=40samesig=0.pdf")
FDR_and_power_plot(FDRmat=FDRmat, powermat=powermat, names=names, cols=cols, pchs=pchs, alpha=q, vary_list,xlab=xlab, title='',leg_coords=c(min(vary_list),0.5),show_legend=TRUE,labelsize=1.5,legsize=1.5,cexsize=1.8)
dev.off()
...
pdf("Continuous_rho_s1=0s2=40samesig=0.pdf")
FDR_and_power_plot(FDRmat=FDRmat, powermat=powermat, names=names, cols=cols, pchs=pchs, alpha=q, vary_list,xlab=xlab, title='',leg_coords=c(min(vary_list),0.5),show_legend=TRUE,labelsize=1.5,legsize=1.5,cexsize=1.8)
dev.off()
...
pdf("Continuous_sigma_s1=0s2=0samesig=0.pdf")
FDR_and_power_plot(FDRmat=FDRmat, powermat=powermat, names=names, cols=cols, pchs=pchs, alpha=q, vary_list,xlab=xlab, title='',leg_coords=c(min(vary_list),0.5),show_legend=TRUE,labelsize=1.5,legsize=1.5,cexsize=1.8)
dev.off()
...
pdf("Continuous_sigma_s1=40s2=40samesig=0.pdf")
FDR_and_power_plot(FDRmat=FDRmat, powermat=powermat, names=names, cols=cols, pchs=pchs, alpha=q, vary_list,xlab=xlab, title='',leg_coords=c(min(vary_list),0.5),show_legend=TRUE,labelsize=1.5,legsize=1.5,cexsize=1.8)
dev.off()
...
pdf("Continuous_sigma_s1=0s2=40samesig=0.pdf")
FDR_and_power_plot(FDRmat=FDRmat, powermat=powermat, names=names, cols=cols, pchs=pchs, alpha=q, vary_list,xlab=xlab, title='',leg_coords=c(min(vary_list),0.5),show_legend=TRUE,labelsize=1.5,legsize=1.5,cexsize=1.8)
dev.off()
